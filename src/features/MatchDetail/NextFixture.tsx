...
import { useGetFixtureUpcoming } from "./useFixture";
...
const NextFixture = () => {
  ...
  const { data: fixtureUpcomings, isLoading } = useGetFixtureUpcoming(
    matchId as string,
    true,
  ...
  const groupedData = groupByTeams(fixtureUpcomings || [], selectedLeague);
  ...
  if (!fixtureUpcomings) {
    return (
      <Block title="Next" padding={false} showNextButton={false}>
  ...
  return (
    <Block title="Next" padding={false} showNextButton={false}>
      ...
      <div className="p-4 flex justify-between items-center">
        ...
        <div className="px-6 flex items-center flex-col space-x-4 gap-4">
          <Image
